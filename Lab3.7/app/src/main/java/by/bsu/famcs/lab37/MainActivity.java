...
public class MainActivity extends Activity implements OnClickListener {
    ...
    public void onClick(View v) {
        if (startFrameAnim.equals(v)) {
            ...
            animationView.setBackgroundResource(R.drawable.ic_launcher1);
        ...
        } else if (comboAnim.equals(v)) {
            animationView.setBackgroundResource(R.drawable.ic_launcher1);
            Animation comboAnimation =
                    AnimationUtils.loadAnimation(this, R.anim.combo);
            animationView.startAnimation(comboAnimation);
        }
    }
}